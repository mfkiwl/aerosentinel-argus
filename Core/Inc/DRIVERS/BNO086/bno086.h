...
#endif
#ifdef MAGNETIC_FIELD_CALIBRATED
// Magnetic field calibrated (in �Tesla). The fully calibrated magnetic field measurement.
BNO_MagneticField_t getMagneticField(void);
#endif
#ifdef MAGNETIC_FIELD_UNCALIBRATED
// Magnetic field uncalibrated (in �Tesla). The magnetic field measurement without hard-iron offset applied
